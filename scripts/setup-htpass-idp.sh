...
htpasswd -b htpasswd sre-user-2 ${PASSWORD}
echo user added sre-user-2 ${PASSWORD}
...
oc adm groups add-users osd-sre-admins sre-user-2


KeycloakRealmCR
Update the Openshift V4 IDP secret to match the one in in rhsso oauthclietn
Link to OHSS
