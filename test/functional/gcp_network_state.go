...
func TestGCPNetworkState(t common.TestingTB, testingCtx *common.TestingContext) {
	...
	network, err := getGcpClusterVpc(ctx, testingCtx.Client, projectID, opt)
	if err != nil {
...
func getGcpClusterVpc(ctx context.Context, client k8sclient.Client, projectID string, opt option.ClientOption) (*computepb.Network, error) {
