	...
	HAPPY_PATH_TESTS = []TestSuite{
		...
		},
		{
			[]TestCase{
				...
				{"H08 - Verify that backend can be created via backend CR", Test3scaleBackendViaCR},
				{"H09 - Verify that product can be created via tenant CR", Test3scaleProductViaCR},
				{"H10 - Verify that tenant can be created via tenant CR", Test3scaleTenantViaCr},
			},
			[]v1alpha1.InstallationType{v1alpha1.InstallationTypeManaged, v1alpha1.InstallationTypeManagedApi, v1alpha1.InstallationTypeMultitenantManagedApi},
		},
		{
