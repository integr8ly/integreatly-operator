	...
	HAPPY_PATH_TESTS = []TestSuite{
		...
		},
		{
			[]TestCase{
				...
				{"E09Obs - Verify customer dashboards exist - Observability", TestIntegreatlyCustomerDashboardsExistObservability},
		...
		},
		{
			[]TestCase{
				...
				{"C04Obs - Verify Alerts exist", TestIntegreatlyAlertsExistObservability},
				{"E01 - Verify Middleware Grafana Route is accessible", TestGrafanaExternalRouteAccessible},
				{"E01Obs - Verify Middleware Grafana Route is accessible", TestGrafanaExternalRouteAccessibleObservability},
				{"E02 - Verify that all dashboards are installed and all the graphs are filled with data", TestDashboardsData},
				{"E02Obs - Verify that all dashboards are installed and all the graphs are filled with data - Observability", TestDashboardsDataObservability},
				{"E03 - Verify middleware dashboards exist", TestIntegreatlyMiddelewareDashboardsExist},
				{"E03Obs - Verify middleware dashboards exist", TestIntegreatlyMiddelewareDashboardsExistObservability},
				/*FLAKY on RHMI/RHOAM*/ {"E05 - Verify Grafana Route returns dashboards", TestGrafanaExternalRouteDashboardExist},
				/*FLAKY on RHMI/RHOAM*/ {"E05Obs - Verify Grafana Route returns dashboards", TestGrafanaExternalRouteDashboardExist},
