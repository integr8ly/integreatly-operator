...
func TestIntegreatlyCustomerDashboardsExist(t TestingTB, ctx *TestingContext) {
	...
	testIntegreatlyCustomerDashboardsExist(t, ctx, MonitoringOperatorNamespace, execToPodCommand)
}
...
func TestIntegreatlyMiddelewareDashboardsExist(t TestingTB, ctx *TestingContext) {
	execToPodCommand := "curl "
	testIntegreatlyMiddelewareDashboardsExist(t, ctx, MonitoringOperatorNamespace, execToPodCommand)
}
