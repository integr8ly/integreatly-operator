...
# Taken from https://github.com/openshift/boilerplate/blob/f3c8c8d393f69f83ce9dbdbc0aa72d2e5b9e5d96/boilerplate/openshift/golang-osd-operator/codecov.sh
...
go test -tags=unittests -covermode=atomic -coverprofile="$COVER_PROFILE".tmp -p "$COV_THREAD_COUNT" -coverpkg=./apis/...,./internal/controller/...,./pkg/... ./apis/... ./internal/controller/... ./pkg/...
