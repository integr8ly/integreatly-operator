...
// Remove this replace once a new keycloak-client release is available to replace v0.1.14.
replace github.com/integr8ly/keycloak-client => github.com/valerymo/keycloak-client v0.0.0-20251210161809-ede157736937
