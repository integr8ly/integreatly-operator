...
require (
	...
	github.com/redhat-developer/observability-operator/v3 v3.0.8-0.20211209212156-6ed7d61df3bd
...
require (
	...
	github.com/openshift/cloud-credential-operator v0.0.0-20190812222907-ec6f38d73a79 // indirect
