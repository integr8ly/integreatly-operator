			...
			Rules: []monv1.Rule{
				{
					...
					Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(namespace, "alertmanager-operated")),
					For:    resources.DurationPtr("5m"),
					Labels: map[string]string{"severity": "warning", "product": installationName},
				},
				{
					...
					Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(namespace, "rhoam-alertmanager")),
					For:    resources.DurationPtr("5m"),
					Labels: map[string]string{"severity": "warning", "product": installationName},
				},
				{
					...
					Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(namespace, "prometheus-operated")),
					For:    resources.DurationPtr("5m"),
					Labels: map[string]string{"severity": "warning", "product": installationName},
				},
				{
					...
					Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(namespace, "rhoam-prometheus")),
					For:    resources.DurationPtr("5m"),
					Labels: map[string]string{"severity": "warning", "product": installationName},
				},
				{
					...
					Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(namespace, "blackbox-exporter")),
					For:    resources.DurationPtr("5m"),
					Labels: map[string]string{"severity": "warning", "product": installationName},
				},
			},
