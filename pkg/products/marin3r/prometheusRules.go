				...
				Rules: []monv1.Rule{
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(threescaleNamespace, "marin3r-instance")),
					...
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "ratelimit")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
				},
