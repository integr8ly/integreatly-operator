				...
				Rules: []monv1.Rule{
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "keycloak")),
					...
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "keycloak-discovery")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
				},
			...
			},
			{
				...
				Rules: []monv1.Rule{
					...
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetOperatorNamespace(), "rhsso-operator-metrics")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
				},
