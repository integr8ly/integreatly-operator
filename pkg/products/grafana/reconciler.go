...
func (r *Reconciler) Reconcile(ctx context.Context, installation *integreatlyv1alpha1.RHMI, product *integreatlyv1alpha1.RHMIProductStatus, client k8sclient.Client) (integreatlyv1alpha1.StatusPhase, error) {
	...
	err = r.createSecrets(ctx, client, installation, &grafanav1alpha1.Grafana{})
	if err != nil || phase != integreatlyv1alpha1.PhaseCompleted {
	...
	phase, err = r.reconcileComponents(ctx, client, installation, &grafanav1alpha1.Grafana{})
	if err != nil || phase != integreatlyv1alpha1.PhaseCompleted {
...
func (r *Reconciler) createSecrets(ctx context.Context, client k8sclient.Client, installation *integreatlyv1alpha1.RHMI, cr *grafanav1alpha1.Grafana) error {
	secret := &v1.Secret{
	...
	if err != nil {
		logrus.Errorf("failed to create grafana proxy secret, %s: %w", secret, err)
	}

	return nil
}

func (r *Reconciler) reconcileComponents(ctx context.Context, client k8sclient.Client, installation *integreatlyv1alpha1.RHMI, cr *grafanav1alpha1.Grafana) (integreatlyv1alpha1.StatusPhase, error) {
