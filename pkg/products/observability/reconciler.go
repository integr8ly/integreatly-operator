	...
	op, err := controllerutil.CreateOrUpdate(ctx, serverClient, oo, func() error {
		...
		oo.Spec = observability.ObservabilitySpec{
			...
			SelfContained: &observability.SelfContained{
				...
				PrometheusDefaultName:                 r.Config.GetPrometheusDefaultName(),
				AlertManagerDefaultName:               r.Config.GetAlertManagerDefaultName(),
				GrafanaDefaultName:                    r.Config.GetGrafanaDefaultName(),
