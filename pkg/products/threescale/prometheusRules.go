				...
				Rules: []monv1.Rule{
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "apicast-production")),
					...
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "apicast-staging")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "critical", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "backend-listener")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "critical", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "system-developer")),
						For:    resources.DurationPtr("5m"),
					...
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "system-master")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "system-memcache")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "system-provider")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "system-searchd")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "zync")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "critical", "product": installationName},
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetNamespace(), "zync-database")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "critical", "product": installationName},
					},
				},
			},
			{
				...
				Rules: []monv1.Rule{
					...
					},
					{
						...
						Expr:   intstr.FromString(resources.NoReadyServiceEndpointsExpr(r.Config.GetOperatorNamespace(), "threescale-operator-controller-manager-metrics-service")),
						For:    resources.DurationPtr("5m"),
						Labels: map[string]string{"severity": "warning", "product": installationName},
					},
				},
