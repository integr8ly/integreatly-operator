				...
				Rules: []monitoringv1.Rule{
					{
						...
						Expr:   intstr.FromString("count(kube_secret_info{namespace='redhat-rhoam-operator', secret='cj3cssrec'}) > 0"),
						For:    "10s",
					...
					},
					{
						...
						Expr:   intstr.FromString("count(kube_secret_info{namespace='redhat-rhoam-operator', secret='wj3cssrew'}) > 0"),
						For:    "10s",
