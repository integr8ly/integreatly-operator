...
func (in *InstallationStatus) DeepCopyInto(out *InstallationStatus) {
	*out = *in
	...
	if in.ProductConfig != nil {
		in, out := &in.ProductConfig, &out.ProductConfig
		*out = make(map[ProductName]ProductConfig, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ProductConfig) DeepCopyInto(out *ProductConfig) {
	{
		in := &in
		*out = make(ProductConfig, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProductConfig.
func (in ProductConfig) DeepCopy() ProductConfig {
	if in == nil {
		return nil
	}
	out := new(ProductConfig)
	in.DeepCopyInto(out)
	return *out
}
