...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakAttributes) DeepCopyInto(out *KeycloakAttributes) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakAttributes.
func (in *KeycloakAttributes) DeepCopy() *KeycloakAttributes {
	if in == nil {
		return nil
	}
	out := new(KeycloakAttributes)
	in.DeepCopyInto(out)
	return out
}
